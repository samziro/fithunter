...
const CTAButton: React.FC<CTAButtonProps> = ({ href, children, className = '' }) => (
  <Link
    href={href}
    className={`p-4 md:px-8 md:py-4  text-lg font-semibold transition-colors font-poppins ${className}`}
  >
    {children}
  </Link>
);
      ...
      >
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto font-inter leading-relaxed">
            Your professional personal trainer in Watamu, Kenya — offering affordable,personal coaching, workout-programs(home or gym workouts) and meal plans that build strength and confidence.
          </p>
          <div className="flex gap-4 justify-center">
            <a href="mailto:1thefithunter@gmail.com" className="px-4 py-2 md:px-8 md:py-4  text-lg font-semibold transition-colors font-poppins text-base bg-button text-textSecondary hover:bg-buttonHover flex items-center justify-center">
              Book a Session
            </a>
      ...
      <section className="py-20 bg-lightBg ">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-lg md:text-xl mb-10 text-textMain font-inter leading-relaxed">
            Get a free consultation with Fit Hunter in Watamu today.
          </p>
